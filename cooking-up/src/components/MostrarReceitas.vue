...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas
      .filter((receita)=> receita.ingredientes.every((ingrediente)=> this.ingredientes.includes(ingrediente)));
  },
...
<template>
  <section class="mostrar-receitas">
    ...
    <BotaoPrincipal texto="Editar lista" @click="$emit('editarIngredientes')" />
  </section>
</template>
